...
class LogInActivity : AppCompatActivity() , NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.nav_share -> supportFragmentManager.beginTransaction().replace(R.id.fragment_container, ReferralFragment()).commit()
            ...
            R.id.adminPanel -> supportFragmentManager.beginTransaction().replace(R.id.fragment_container, AdminPanelFragment()).commit()
        }
        ...
        if (user != null) {
            ...
            userRef.get().addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    // 🔐 Hide or show Admin Panel based on role
